import BlogDetails from '../../features/blog/components/Detail/index.tsx';

export const data = {
  title: 'Lorem Ipsum - King of all Kings',
  author: 'John Doe',
...
const test = 'new test';
console.log({ test });
// This is a commentblock
```

export default ({ children }) => <BlogDetails content={children} data={data} />;
